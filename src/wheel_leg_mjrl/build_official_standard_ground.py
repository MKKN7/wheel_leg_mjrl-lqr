...
GEOMETRY_PATH = ROOT / "configs" / "official_terrain_geometry.yaml"
...
def validate_official_warp_scene(
    ...
    *,
    ...
    # Geometry configuration lives in configs/, while generated MJCF scenes
    # remain at repository root for backward-compatible launcher paths.
    if not canonical_path.is_file():
        canonical_path = geometry_file.parent.parent / str(scene["output_xml"])
    if not canonical_path.is_file():
