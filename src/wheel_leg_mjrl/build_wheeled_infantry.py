...
def generate_outputs():
    ...
    with open(os.path.join(REPORTS_DIR, "classification_summary.json"), "w", encoding="utf-8") as f:
...
if __name__ == "__main__":
    ...
    os.makedirs(REPORTS_DIR, exist_ok=True)
    with open(os.path.join(REPORTS_DIR, "classification_rows.json"), "w", encoding="utf-8") as f:
