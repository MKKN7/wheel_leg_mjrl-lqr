    ...
    def __init__(
        ...
        *,
        ...
        self._safety_limits = WarpSafetyLimits(
            ...
            run_mode=batch.config.safety.run_mode,
            torque_limit_ratio_sim=batch.config.safety.torque_limit_ratio_sim,
            torque_limit_ratio_real=batch.config.safety.torque_limit_ratio_real,
            current_limit_A=batch.config.safety.current_limit_A,
